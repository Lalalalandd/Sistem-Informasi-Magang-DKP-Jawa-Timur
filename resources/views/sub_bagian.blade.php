                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-warning" type="button" data-toggle="modal"
                                                        data-target="#editdata<?= $x ?>"><i class="mr-1"><svg
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/subbagian/{{ $d->id }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label for="subbagian"
                                                                        class="col-form-label">Sub Bagian:</label>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action="/subbagian" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="sub_bagian" class="col-form-label">Sub Bagian:</label>
                                <input type="text" class="form-control @error('sub_bagian') is-invalid @enderror"
                                    id="sub_bagian" name="sub_bagian" required placeholder="Isi nama Sub Bagian"
                                    value="{{ old('subbagian') }}">
                                @error('sub_bagian')
