                    ...
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($universitas as $d)
                                            <tr>
                                                ...
                                                <td class="align-middle"><?= $d->universitas ?></td>
                                                <td>
                                                    <div class="d-flex d-inline">
                                                        ...
                                                        <form action="/universitas/{{ $d->id }}" method="POST"
                                                            class="d-inline">
                                                            {{ csrf_field() }}
                                                            @method('delete')
                                                            @csrf
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Edit Data Universitas</h4>
                                                        ...
                                                        <form action="/universitas/{{ $d->id }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label for="universitas" class="col-form-label">Sub
                                                                        Bagian:</label>
                            ...
                            <div class="card-footer clearfix"
                                style="max-height: 65px !important; {{ $universitas->hasPages() ? '' : 'height: 45px !important;' }}">
                                {{ $universitas->links('vendor.pagination.bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action="/universitas" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="universitas" class="col-form-label">Sub Bagian:</label>
                                <input type="text" class="form-control @error('universitas') is-invalid @enderror"
                                    id="universitas" name="universitas" required placeholder="Isi nama Sub Bagian"
