...
<nav class="mt-3">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="/beranda_mahasiswa" class="nav-link {{ $tittle === 'Beranda' ? 'active' : '' }}">
                <i class="nav-icon">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="./index.html" class="nav-link {{ $tittle === 'Mahasiswa' ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Mahasiswa</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="./index2.html" class="nav-link {{ $tittle === 'Pegawai' ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Pegawai</p>
                    </a>
                </li>
        ...
        <li class="nav-item">
            <a href="/magang_mahasiswa" class="nav-link {{ $tittle === 'Tugas' ? 'active' : '' }}">
                <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"
        ...
        <li class="nav-item">
            <a href="/tugas_mahasiswa" class="nav-link {{ $tittle === 'Tugas' ? 'active' : '' }}">
                <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"
